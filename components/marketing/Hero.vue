    ...
    <div class="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8">
      <div class="space-y-5 max-w-4xl mx-auto text-center">
        ...
        <h2 class="text-4xl text-gray-800 font-extrabold mx-auto md:text-5xl">
          Ship you startup fast with  <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#4ade80] to-[#166534]">the best Nuxt starter</span>
        </h2>
        <p class="max-w-2xl mx-auto">
          More than a template. This is a fully working project with all the essential features you need to build your SAAS.
        </p>
